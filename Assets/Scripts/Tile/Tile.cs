...
public class Tile
{
    ...
    public int Weight { get; set; } // xác định tường và lối đi
    public int Cost { get; set; }   // lưu chi phí tính từ điểm bắt đầu
    public Tile PrevTile { get; set; } // lưu Tile trước đó, hỗ trợ truy vết đường đi tối ưu.
